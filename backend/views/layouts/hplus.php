...
<!--     <title>H+ 后台主题UI框架 - 主页</title> -->
    ...
    <link href="/hplus/css/bootstrap.min.css?v=1.7" rel="stylesheet">
    <link href="/hplus/font-awesome/css/font-awesome.css?v=1.7" rel="stylesheet">
    ...
    <link href="/hplus/css/style.css?v=1.7" rel="stylesheet">
...
<!--                     <li class="active"> -->
                    ...
                    <li class="active">
                        <a href="/index.php?r=testhplus/index">
                        	<i class="fa fa-th-large"></i> 
                        	<span class="nav-label">Test页</span> 
                        	<span class="fa arrow"></span>
                        </a>
                        <ul class="nav nav-second-level">
                            <li>
                            	<a href="/index.php?r=testhplus/test1">test示例一</a>
                            </li>
                            <li>
                            	<a href="/index.php?r=testhplus/test2">test示例二</a>
                            </li>
                            <li>
                            	<a href="index_3.html">test示例三</a>
                            </li>
                        </ul>
                    </li>
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            ...
            <div class="row  border-bottom white-bg dashboard-header">
                ...
                <div class="col-sm-3">
                    ...
                    <br>
                    <br>
                    <img src="/hplus/img/qr_code.png" width="100%" style="max-width:264px;">
                    <br>
                </div>
                <div class="col-sm-5">
                    <h2>
                    ...
                    <p>H+是一个完全响应式，基于Bootstrop3.3.0最新版本开发的扁平化主题，她采用了主流的左右两栏式布局，使用了Html5+CSS3等现代技术，她提供了诸多的强大的可以重新组合的UI组件，并集成了最新的jQuery版本(v2.1.1)，当然，也集成了很多功能强大，用途广泛的就jQuery插件，她可以用于所有的Web应用程序，如<b>网站管理后台</b>，<b>网站会员中心</b>，<b>CMS</b>，<b>CRM</b>，<b>OA</b>等等，当然，您也可以对她进行深度定制，以做出更强系统。</p>
                    <p>
                        <b>当前版本：</b>v1.7
                    </p>
                    <p>
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="ibox float-e-margins">
                                    ...
                                    <div class="ibox-content">
                                        ...
                                        <a href="http://www.zi-han.net/theme/se7en/" target="_blank" class="btn btn-w-m btn-info">了解详细</a>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-4">
                                <div class="ibox float-e-margins">
                                    ...
                                    <div class="ibox-content">
                                        ...
                                        <p>
                                            <img src="/hplus/img/alipay_qr_code.png" width="100%" style="max-width:369px">
                                        </p>
                                    ...
                                    <div class="ibox-content no-padding">
                                        <div class="panel-body">
                                            <div class="panel-group" id="version">
                                                ...
                                                <a data-toggle="collapse" data-parent="#version" href="#v17">v1.7</a><code class="pull-right">2014.12.03</code>
                                            </h5>
                                                    </div>
...
<!--                 </div> -->
    ...
    <script src="/hplus/js/bootstrap.min.js?v=1.7"></script>
    ...
    <script src="/hplus/js/hplus.js?v=1.7"></script>
